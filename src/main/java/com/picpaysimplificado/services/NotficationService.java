...
public class NotficationService {
    ...
    public void sendNotfication(User user, String message) throws Exception {
       ...
       //if (!(notificationResponse.getStatusCode() == HttpStatus.OK)){
          // System.out.println("Erro ao enviar noticação");
          // throw new Exception("Serviço de notificação está fora do ar ");

       //}
        System.out.println("Notificação enviada para o usario");
    }
}
